...
(Get-Content "$PSScriptRoot\assettocorsa\apps\lua\RARE\RARE.lua") | ForEach-Object { $_ -replace "
SCRIPT_BUILD_DATE =.+","SCRIPT_BUILD_DATE = `"$date`""  } | Set-Content "$PSScriptRoot\assettocorsa\apps\lua\RARE\RARE.lua"
