...
local function avgTyreWearBelowLimit(driver)
	local avgTyreLimit = 1 - (RARE_CONFIG.AI.AI_AVG_TYRE_LIFE + driver.aiTyreAvgRandom) / 100
	local avgTyreWear = (
...
local function singleTyreWearBelowLimit(driver)
	local singleTyreLimit = 1 - (RARE_CONFIG.AI.AI_SINGLE_TYRE_LIFE + driver.aiTyreSingleRandom) / 100
