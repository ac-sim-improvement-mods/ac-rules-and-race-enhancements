function debugMenu(sim,rc,error)
    ...
    if driver.car.isAIControlled then
        ui.treeNode("[AI]", ui.TreeNodeFlags.DefaultOpen and ui.TreeNodeFlags.Framed, function ()
            ...
            inLineBulletText("Tyre Life Avg Limit", RARECONFIG.data.AI.AI_AVG_TYRE_LIFE + driver.aiTyreAvgRandom.." %",space,driver)
            inLineBulletText("Tyre Life Single Limit", RARECONFIG.data.AI.AI_SINGLE_TYRE_LIFE + driver.aiTyreSingleRandom.." %",space,driver)
