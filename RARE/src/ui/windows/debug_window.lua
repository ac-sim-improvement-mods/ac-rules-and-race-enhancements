...
local function damageTreeNode(driver)
	ui.treeNode("[DAMAGE]", ui.TreeNodeFlags.DefaultOpen and ui.TreeNodeFlags.Framed, function()
		ui.inLineBulletText("Front Body Damage", driver.car.damage[0], space)
		ui.inLineBulletText("Rear Body Damage", driver.car.damage[1], space)
		ui.inLineBulletText("Left Body Damage", driver.car.damage[2], space)
		ui.inLineBulletText("Right Body Damage", driver.car.damage[3], space)
		ui.inLineBulletText("FL Susp Damage", driver.car.wheels[0].suspensionDamage, space)
		ui.inLineBulletText("FR Susp Damage", driver.car.wheels[1].suspensionDamage, space)
		ui.inLineBulletText("RL Susp Damage", driver.car.wheels[2].suspensionDamage, space)
		ui.inLineBulletText("RR Susp Damage", driver.car.wheels[3].suspensionDamage, space)
...
local function sessionTreeNode(sim, rc, driver)
	ui.treeNode(
		...
		function()
			...
			ui.inLineBulletText("Online Race", ui.upperBool(sim.isOnlineRace), space)
